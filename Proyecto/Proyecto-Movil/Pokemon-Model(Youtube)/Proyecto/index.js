...
class Sprite{
    constructor({ position, velocity, image, frames = { max : 1 } }){//se insertar un objeto como argumento del constructor
        this.position = position
        this.image = image
        this.frames = frames
...
const movables = [background, ...boundaries]//une sus elementos a la lista ...
...
function animate(){
    window.requestAnimationFrame(animate) // Creas un bucle infinito en el cual trabajar las animaciones
    background.draw()
